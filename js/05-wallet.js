...
async function saveFlightCoreData(leg){
  ...
  if($('walletDepartureTerminalInput'))trips[idx][departureKey]=$('walletDepartureTerminalInput').value.trim().slice(0,80);
  if($('walletArrivalTerminalInput'))trips[idx][arrivalKey]=$('walletArrivalTerminalInput').value.trim().slice(0,80);
